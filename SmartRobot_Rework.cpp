...
details::WiFiStuff WiFi;
details::SerialImpl Serial;
details::SerialImpl Serial2;
...
sr::MyString message, receiveBuff;
...
void sendAssignmentToRobot(void)
{
    ...
    for (uint8_t i = 0; i < obj.pa.waypoints.size(); ++i)
    {
